...
/*
************ billingPro in frn folder contains work on offer buy n get m free work
this file contains offer related to one series with variable discount
*/
                ...
                if (counter > 2) {
                    ...
                    $(sch_bar).each(function(i, v) {
                        ...
                        $.post("../Central/fetch_barcode_data_out.php", {
                            ...
                            var r = JSON.parse(rt);
                            //console.log(r);
                            var mrpdata = get_mrpdata(mrp, r.discount);
