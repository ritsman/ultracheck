...
if($dtd==""){
    ...
    $q="select * from `Q__challan_main` where  too='$outlet' or too='$outlet-C'";
}else{
    $q="select * from `Q__challan_main` where  (too='$outlet' or too='$outlet-C') and (chdt between '$dtd' and '$dtd2')";
