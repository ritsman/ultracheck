...
<div class="pageShow2">
    ...
    <form id="POForm"  class="noshow" action="showAPPChallan.php" target="_blank" method="post">
    ...
    <hr>
    <h4>CHALLAN LIST OF GOODS DESPATCHED FROM <span id="shopname"></span></h4>
    ...
    <script>
        $("#updBar").click(function(){
            ...
            $("#showdata").load("P_apptrans.php",{outlet:outlet,dtd:dtd,dtd2:dtd2});
