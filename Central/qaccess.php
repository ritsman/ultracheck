...
<div class="row">
    <div class="col-lg-3">
        <div class="card card-margin">
            <div class="card-header no-border">
                <h5 class="card-title">PALSANA</h5>
            </div>
    ...
    <div class="col-lg-3">
        <div class="card card-margin">
            <div class="card-header no-border">
                <h5 class="card-title">HIMMATNAGAR</h5>
            </div>
            <div class="card-body pt-0">
                <div class="widget-49">
                    <div class="widget-49-title-wrapper">
    ...
    <div class="col-lg-3">
        <div class="card card-margin">
            <div class="card-header no-border">
                <h5 class="card-title">VISNAGAR</h5>
            </div>
            <div class="card-body pt-0">
                <div class="widget-49">
                    <div class="widget-49-title-wrapper">
...
<div class="row">
    <div class="col-lg-3">
        <div class="card card-margin">
            <div class="card-header no-border">
                <h5 class="card-title">VATVAGIDC</h5>
            </div>
            <div class="card-body pt-0">
                <div class="widget-49">
                    <div class="widget-49-title-wrapper">
    ...
    <div class="col-lg-3">
        <div class="card card-margin">
            <div class="card-header no-border">
                <h5 class="card-title">GITAMANDIR</h5>
            </div>
            <div class="card-body pt-0">
                <div class="widget-49">
                    <div class="widget-49-title-wrapper">
    ...
    <div class="col-lg-3">
        <div class="card card-margin">
            <div class="card-header no-border">
                <h5 class="card-title">JAHGIRPURA</h5>
            </div>
            <div class="card-body pt-0">
                <div class="widget-49">
                    <div class="widget-49-title-wrapper">
...
<script>
    $("span.widget-49-date-day").text("12-15");
</script>