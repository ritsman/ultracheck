...
<div class="pageShow2">
    ...
    <form id="POForm"  class="noshow" action="showChallan.php" target="_blank" method="post">
    ...
    <hr>
    <h4>CHALLAN LIST OF GOODS DESPATCHED FROM CENTRAL <span id="shopname"></span></h4>
    ...
    <script>
        $("#updBar").click(function(){
            ...
            $("#showdata").load("P_chlnsumm.php",{outlet:outlet,dtd:dtd,dtd2:dtd2});
