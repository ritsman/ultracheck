...
<!-- this is addition for stock verify -->
    ...
    <button type="button" name="updBar" id="updBar" class="btn btn-info m-2">SAVE LIST</button>
    <button type="button" name="delBar" id="delBar" class="btn btn-info m-2">RESET</button>
    <button type="button" name="expBar" id="expBar" class="btn btn-info m-2">EXPORT</button>
    </div>
   ...
   <script>
       $("#showinv").click(function(){
           ...
           if(search_data.goahead=='yes'){
            ...
            $("div#showdata").load("P_stockVerify.php",{data:data,search_data:search_data},function(response,status,xhr){
                if(status=='error'){
