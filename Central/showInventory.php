...
var auxul = "<ul id='aux-ul'><li><a href=\"#\" class=\"bkch\" id='showInventory' onclick='track(this)'>Challan</a></li>";
    auxul += "<li><a href=\"#\" id='series_sum' onclick='track(this)'>Series Sum</a></li>";
    auxul += "<li><a href=\"#\" id='stockVerify' onclick='track(this)'>Stock Verify</a></li>";
    auxul += "<li><a href=\"#\" id='changeMrp' onclick='track(this)'>Change MRP</a></li>";
    auxul += "</ul>";
